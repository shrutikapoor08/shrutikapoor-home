---
title: How to create fun animations with only HTML Canvas and JavaScript
...
{% embed https://www.youtube.com/watch?v=IjPgXP3gDyI&ab_channel=ShrutiKapoor %}
...
[Here’s the final codepen](https://codepen.io/shrutikapoor08/pen/wvQXMVO
