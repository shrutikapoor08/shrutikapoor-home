...
1. Learn git and version control. [Here's an instructional video](https://youtu.be/8JJ101D3knE)
...
1. Step up your JS and CSS knowledge
...
1. Step up challenge - learn a front-end framework.
...
1. Step up challenge: Learn a library for the framework.
...
1. Learn a testing framework: Build test coverage. Add to your portfolio. Eg: [Jest](https://jestjs.io/)
1. Get a freelance job using your portfolio. Some places to find freelance opportunities are [Upwork](https://www.upwork.com) & [Fiverr](https://www.fiverr.com/)
1. Find a mentor. Get feedback on your skills and portfolio.
1. Apply for a job. You are ready.
