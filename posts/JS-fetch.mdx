---
title: JSByte - How to use fetch API to make AJAX requests in JavaScript?
description: 'Fetch is an interface for making an AJAX request in JavaScript. It is implemented widely by modern browsers and is used for calling an API.'
date: June 26, 2020
---
