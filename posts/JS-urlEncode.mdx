...
description: "You might think that encodeURI and encodeURIComponent do the same thing, at least from their names. And you might be confused which one to use and when.
