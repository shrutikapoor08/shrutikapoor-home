          ...
          <div className="relative flex-grow w-full">
            ...
            >
              <input
                ...
                name="email"
                placeholder="Email"
                className="bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none py-1 px-3 mx-3 leading-8 transition-colors duration-200 ease-in-out"
              />
